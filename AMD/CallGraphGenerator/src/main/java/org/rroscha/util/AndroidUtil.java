...
public class AndroidUtil
{
    ...
    public static boolean isAndroidMethod(SootMethod sootMethod)
    {
        ...
        List<String> androidPrefixPkgNames = Arrays.asList("android.", "com.google.android", "androidx.", "com.android.internal.util",
                "dalvik.", "java.", "javax.", "org.apache.", "org.json.", "org.w3c.dom.", "org.xml.sax", "org.xmlpull.v1.", "junit.");
